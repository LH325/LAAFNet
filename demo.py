...
save prediction files in the ./samples/R+N
...
def get_args():
    ...
    parser.add_argument('--output_folder', default='samples/ZY', type=str)
    ...
    parser.add_argument('--net_G', default='xception', type=str,
                        help='base_resnet18 | base_transformer_pos_s4_dd8 | base_transformer_pos_s4_dd8_dedim8|')
    parser.add_argument('--checkpoint_name', default='RGB.pt', type=str)
